...
package gnuplot.dataset;

import gnuplot.dataset.parser.DataParser;
import gnuplot.dataset.parser.DoubleDataParser;
...
public class GenericDataSet extends ArrayList<ArrayList<String>> implements DataSet {
     ...
     * @throws NumberFormatException If the given collection is not in
     * the correct format
     */
