...
import gnuplot.layout.LayoutMetrics;
 ...
 * plots which share the same axis. All com.gnuplot objects have at least one graph
 * object.
 * <p>
...
public class Graph extends ArrayList<Plot> {
    ...
    /**
     * Get com.gnuplot commands for this graph.
     *
     * @param bf
     */
    ...
    /**
     * Get the actual com.gnuplot command to initiate the plot.
     *
