...
/**
 * This terminal is able to process com.gnuplot output as an image. The image
...
public class ImageTerminal extends FileTerminal {
    ...
    /**
     * Read the produced image from com.gnuplot standard output
     *
     * @param stdout The com.gnuplot output stream
    ...
    public String processOutput(InputStream stdout) {
        ...
        if (img == null)
            return "Unable to create image from the com.gnuplot output. Null image created.";
        return null;
    }
