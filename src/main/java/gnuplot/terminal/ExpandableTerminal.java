...
import gnuplot.PropertiesHolder;
 ...
 * provides support for terminal types and consumes unwanted com.gnuplot output.
 *
 * @author teras
 */
public abstract class ExpandableTerminal extends PropertiesHolder implements GNUPlotTerminal {
    ...
    /**
     * This method only consumes com.gnuplot stdout input stream. It is performed to
    ...
    public String processOutput(InputStream stdout) {
        ...
        try {
            ...
            return "I/O error while processing com.gnuplot output: " + ex.getMessage();
        }
        return null;
    }
}
