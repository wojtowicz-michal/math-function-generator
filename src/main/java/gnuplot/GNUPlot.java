...
import gnuplot.layout.GraphLayout;
import gnuplot.plot.Axis;
import gnuplot.plot.Graph;
import gnuplot.plot.Page;
import gnuplot.plot.Plot;
import gnuplot.terminal.DefaultTerminal;
 ...
 * com.gnuplot. Typically the user needs to create a new instance of this object and
...
public class GNUPlot {
    ...
    /**
     * GNUPlot parameters. Here we store all com.gnuplot information.
     */
    ...
    /**
     * Create a new instance of com.gnuplot, using the default parameters
     *
    ...
    /**
     * Create a new instance of com.gnuplot, using the default parameters. Use this
    ...
    /**
     * Create a new instance of com.gnuplot, with a given set of parameters.
     *
     * @see #GNUPlot(String)
     * @see #GNUPlot(GNUPlotParameters,String,GNUPlotTerminal,boolean)
    ...
    /**
     * Create a new instance of com.gnuplot, with given parameters and given path
     * for com.gnuplot.
     * <p>
     ...
     * whole com.gnuplot variables, including data sets.
     * @param gnuplotpath The pathname of the com.gnuplot executable. If this
     * parameter is set to null, use the default path.
     * @param term The com.gnuplot terminal to use
     * @throws GNUPlotException If the com.gnuplot executable
     * is not found, this exception is thrown. It means that the provided path
     * for com.gnuplot is not valid.
     */
    ...
    public GNUPlot(GNUPlotParameters par, String gnuplotpath, GNUPlotTerminal term, boolean isGraph3D) throws GNUPlotException {
        ...
        try {
            ...
            if (gnuplotpath == null)
                msg += " Please provide com.gnuplot path to the constructor of GNUPlot.";
     ...
     *
     * @param key The key to use for this com.gnuplot
     ...
     * draw to a new plot com.gnuplot object, create a new page.
     *
     * @see #newGraph3D()
     */
     ...
     * order to draw to a new plot com.gnuplot object, create a new page.
     *
     * @see #newGraph()
     */
     ...
     *
     * @throws GNUPlotException This exception is thrown
...
//    }
    ...
    /**
     * Set com.gnuplot parameters to another set of parameters.
     *
    ...
    /**
     * Ge the actual com.gnuplot parameters. This method is useful if the developer
    ...
    /**
     * Change com.gnuplot terminal. Use this method to make com.gnuplot draw to another
    ...
    /**
     * Execute com.gnuplot commands before any kind of initialization. This method
     * together with getPostInit() is useful to add basic commands to com.gnuplot
